...
<br>
            <div class="card shadow">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('berita-terbaru.destroy', $item->id) }}" method="POST">
                    <a class="btn btn-warning" href="{{ route('berita-terbaru.edit',$item->id) }}"> <i class="fa fa-edit"> Ubah</i> </a>
                  @csrf
                  @method('DELETE')
