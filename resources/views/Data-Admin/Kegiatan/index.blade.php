...
@section('content')
    ...
    <a class="btn btn-success" href="{{ route('kegiatan.create') }}"> <i class="fa fa-plus"> Tambah Data</i> </a>
    &nbsp;&nbsp;&nbsp;&nbsp;
<br>
            ...
            <div class="card shadow">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('kegiatan.destroy', $item->id) }}" method="POST">
                    <a class="btn btn-warning" href="{{ route('kegiatan.edit',$item->id) }}"> <i class="fa fa-edit"> Ubah</i> </a>
                  @csrf
                  @method('DELETE')
