...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="{{ url('anggotapemuda') }}" class="logo">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                      <li><a href="{{url('apassword')}}"><i class="fa fa-gear fa-fw"></i> Ganti Passwor Baru</a></li><br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('avisimisi')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Visi dan Misi</a></li>
            <li><a href="{{ url('aorganisasi') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Struktur Organisasi</a></li>
            <li><a href="{{ url('asejarah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Sejarah</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('datapusat') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Kordinator Pusat</a></li>
            <li><a href="{{url('datawilayah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Wilayah</a></li>
            <li><a href="{{ url('dataklasis') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Klasis</a></li>
            <li><a href="{{ url('datapemuda') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Pemuda</a></li>
            <li><a href="{{ url('anggota') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Anggota Pemuda</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('aprogram-pusat') }}"><i class="	fa fa-chevron-circle-down nav-icon"></i> Kordinatr Pusat</a></li>
            <li><a href="{{ url('aprogram-wilayah') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Wilayah</a></li>
            <li><a href="{{ url('aprogram-klasis') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Klasis</a></li>
          </ul>
        </li>
        <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('aiuran') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Iuran Wajib</a></li>
              <li><a href="{{ url('adanalain') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Dana Lain</a></li>
            </ul>
          </li>
          <li>
            <a href="{{ url('akegiatan') }}">
              <i class="nav-icon fas fa-clone"></i> <span> Kegiatan</span>
            </a>
          </li>
        <li class="treeview">
          <a href="{{ url('arenungan') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('avideo') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Video</a></li>
              <li><a href="{{url('afoto')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Foto</a></li>
            </ul>
          </li>    
          <li>
        </li>
   ...
   <div class="content-wrapper">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header"> <a href="{{ url('anggotapemuda') }}">Home</a> {{ __('/ Dashboard') }}</div>
              <hr>
         </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="card-title fw-bold  "> <h4><i class="fas fa-arrow-circle-right"></i> <b> {{ $p->judul }}</b></h4></div>
                ...
                <a  href="{{ url('apengumuman/show', $p->id) }}" class="btn btn-primary"> Selekapnya</a> 
              <br><br>
