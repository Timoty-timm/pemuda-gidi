...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="{{ url('bendahara') }}" class="logo">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                      <li><a href="{{url('bpassword')}}"><i class="fa fa-gear fa-fw"></i> Ganti Passwor Baru</a></li><br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('bvisimisi')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Visi dan Misi</a></li>
            <li><a href="{{ url('borganisasi') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Struktur Organisasi</a></li>
            <li><a href="{{ url('bsejarah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Sejarah</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('bpusat') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Kordinator Pusat</a></li>
            <li><a href="{{url('bwilayah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Wilayah</a></li>
            <li><a href="{{ url('bklasis') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Klasis</a></li>
            <li><a href="{{ url('bpemuda') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Pemuda</a></li>
            <li><a href="{{ url('banggota') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Anggota Pemuda</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('bprogram-pusat') }}"><i class="	fa fa-chevron-circle-down nav-icon"></i> Kordinatr Pusat</a></li>
            <li><a href="{{ url('bprogram-wilayah') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Wilayah</a></li>
            <li><a href="{{ url('bprogram-klasis') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Klasis</a></li>
          </ul>
        </li>
        <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('iuran') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Iuran Wajib</a></li>
              <li><a href="{{ url('bkeuangan') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Dana Lain</a></li>
            </ul>
          </li>
          <li>
            <a href="{{ url('bkegiatan') }}">
              <i class="nav-icon fas fa-clone"></i> <span> Kegiatan</span>
            </a>
          </li>
        <li >
          <a href="{{ url('brenungan') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('bvideo') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Video</a></li>
              <li><a href="{{url('bfoto')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Foto</a></li>
            </ul>
          </li>    
          <li>
        </li>
   ...
   <div class="content-wrapper">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header"> <a href="{{ url('bendahara') }}">Home</a> {{ __('/ Dashboard') }}</div>
              <hr>
         </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="card-title fw-bold  "> <h4><i class="fas fa-arrow-circle-right"></i> <b> {{ $p->judul }}</b></h4></div>
                ...
                <a  href="{{ url('datapepe/show', $p->id) }}" class="btn btn-primary"> Selekapnya</a> 
              <br><br>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box " style="background: rgb(100, 137, 194)" >
                ...
                <a href="{{ url('banggota') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>           
            </div>
       ...
       {{-- <div class="col-lg-3 ">
       <br>
        <div class="card shadow" style="background: #CC6600">
    ...
    <div class="col-lg-3 ">
      <br>
       <div class="card shadow " style="background: #CCCC00">
   ...
   <div class="col-lg-3 ">
    <br>
     <div class="card shadow  " style="background: #66CC00">
 ...
 <div class="col-lg-3 ">
  <br>
   <div class="card shadow  " style="background:#00CC00">
...
<div class="col-lg-3 ">
  <br>
   <div class="card shadow  " style="background: #00994D">
...
<div class="col-lg-3 ">
  <br>
   <div class="card shadow" style="background: #009999">
...
<div class="col-lg-3 ">
  <br>
   <div class="card shadow " style="background:	#004C99" >
...
<div class="col-lg-3 ">
  <br>
   <div class="card shadow " style="background:	#6600CC">
...
<!-- End Content halaman admin -->
  ...
  <!-- Halaman Footer -->
  <footer class="main-footer btn-primary text-center" style="background: gray">
