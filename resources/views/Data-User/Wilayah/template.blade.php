...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                      <li><a href="{{url('wpassword')}}"><i class="fa fa-gear fa-fw"></i> Ganti Passwor Baru</a></li><br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('wvisimisi')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Visi dan Misi</a></li>
            <li><a href="{{ url('worganisasi') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Struktur Organisasi</a></li>
            <li><a href="{{ url('wsejarah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Sejarah</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('wpusat')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Kordinator Pusat</a></li>
            <li><a href="{{url('dwilayah')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Wilayah</a></li>
            <li><a href="{{url('wklasis')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Klasis</a></li>
            <li><a href="{{url('wpemuda')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Pengurus Pemuda</a></li>
            <li><a href="{{url('wanggota')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Data Anggota Pemuda</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('wprogram-pusat') }}"><i class="	fa fa-chevron-circle-down nav-icon"></i> Kordinatr Pusat</a></li>
            <li><a href="{{ url('wilayahs') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Wilayah</a></li>
            <li><a href="{{ url('wprogram-klasis') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Kordinator Klasis</a></li>
          </ul>
        </li>
        <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('wiuran') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Iuran Wajib</a></li>
              <li><a href="{{ url('wdanalain') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Dana Lain</a></li>
            </ul>
          </li>
          <li>
            <a href="{{ url('wkegiatan') }}">
              <i class="nav-icon fas fa-clone"></i> <span> Kegiatan</span>
            </a>
          </li>
        <li>
          <a href="{{ url('wrenungan') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url('wvideo') }}"><i class="fa fa-chevron-circle-down nav-icon"></i> Video</a></li>
              <li><a href="{{url('wfoto')}}"><i class="fa fa-chevron-circle-down nav-icon"></i> Foto</a></li>
            </ul>
          </li>    
          <li>
        </li>
   ...
   <div class="content-wrapper">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"> <a href="{{ url('wilayah') }}">Home</a> {{ __('/ Dashboard') }}</div>
                <hr>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="card-title fw-bold  "> <h4><i class="fas fa-arrow-circle-right"></i> <b> {{ $p->judul }}</b></h4></div>
                ...
                <a  href="{{ url('wpengumuman/show', $p->id) }}" class="btn btn-primary"> Selekapnya</a> 
              <br><br>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box " style="background: rgb(100, 137, 194)" >
                ...
                <a href="{{ url('wanggota') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>           
            </div>
          </div>
{{-- 
